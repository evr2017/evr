...
//        Log.i(TAG, this.hashCode() + ".onNewIntent()");
    ...
    private class ActivityEventListener extends VrVideoEventListener {
        ...
        public void onLoadError(String errorMessage) {
            ...
            Toast.makeText(
                    DiscoverSectionActivity.this, "Error loading video: " + errorMessage, Toast.LENGTH_LONG)
                    .show();
        ...
        protected Boolean doInBackground(Pair<Uri, VrVideoView.Options>... fileInformation) {
            try {
                ...
                videoWidgetView.post(new Runnable() {
                    ...
                    public void run() {
                        Toast
                                .makeText(DiscoverSectionActivity.this, "Error opening file. ", Toast.LENGTH_LONG)
                                .show();
                    }
                });
